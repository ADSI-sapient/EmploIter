                 ...
                 <form action="<?php echo URL; ?>ctrEmpleado/regEmpleado" method="POST"">
                  ...
                  <div class="row col-lg-12">
                    ...
                    <select  class="form-control" name="cargo" required="" style="border-radius:5px;">
                        ...
                        <option value="4">Director Financiero</option>
                        <option value="5">Asesor Comercial</option>
                        <option value="6">Cortador</option>
                        <option value="7">Soldador</option>
                        <option value="8">Pintor</option>
                        <option value="9">Gerente de Producción</option>
                        <option value="10">Recepcionista</option>
                        <option value="11">Gerente Talento Humano</option>
                    </select>
                    </div>
                    <div class="form-group col-lg-4">  
                      <label for="salario" class="">*Salario:</label>
                      <input type="text" name="salario" class="form-control" required="" style="border-radius:5px;">
                    </div>
                </div>
                <div class="row col-lg-12">
                    <div class="form-group col-lg-4">  
